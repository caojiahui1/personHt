    ...
    <div class="table">
        ...
        <div class="handle-box">
            ...
            <el-row :gutter="10">
             ...
             <el-col :span="4"><el-input v-model="select_word" placeholder="筛选关键词" ></el-input></el-col>
             <el-col class="text-center lineHeight" :span="2">手机号</el-col>
             <el-col :span="4"><el-input v-model="select_word" placeholder="筛选关键词" ></el-input></el-col>
            </el-row>
        ...
        <el-col :span="20"> 
            <el-button>禁封账号</el-button>
            <el-button>解封账号</el-button>
            <el-button>删除</el-button>
            <el-button>复位账号</el-button>
        </el-col>
        <el-col :span="4">
        ...
        <el-table :data="tableData" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="操作" width="200" fixed="right">
               <!--  <template scope="scope">
                 ...
                 <template scope="scope">
                    <el-button size="small"  @click="dialogTableVisible = true">替身机器人管理</el-button>
