    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-menu"></i> 朋友圈管理</el-breadcrumb-item>
        ...
        <div class="handle-box">
            ...
            <el-row :gutter="10">
             ...
             <el-col class="text-center lineHeight" :span="2">空间名</el-col>
             <el-col :span="4"><el-input v-model="select_word" placeholder="筛选关键词" ></el-input></el-col>
        ...
        <el-table :data="tableData" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="sex" label="内容" width="120">
            </el-table-column>
            <el-table-column prop="phone" label="点赞数" width="150">
            </el-table-column>
            <el-table-column prop="moneyPage" label="回复数" width="120">
            </el-table-column>
            <el-table-column prop="registerTime" label="打赏数" width="180">
            </el-table-column>
...
<el-dialog title="朋友圈详情"  :visible.sync="dialogContentVisible">
<el-row class="mr10">
